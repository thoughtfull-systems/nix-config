{ config, lib, pkgs, thoughtfull, unstable, ... }: {
  age.secrets = {
    initrd_ssh_host_ed25519_key.file = ../../age/secrets/raspi3b-boot-ed25519.age;
    initrd_ssh_host_rsa_key.file = ../../age/secrets/raspi3b-boot-rsa.age;
  };
  boot = {
    cleanTmpDir = true;
    initrd = {
      availableKernelModules = [ "smsc95xx" "usb_storage" "usbhid" ];
